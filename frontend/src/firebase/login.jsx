...
const Login = ({ThemeChanger}) => {
    ...
    const Login1 = () => {
        console.log("firebase Login1 " + data);
                                ...
                                <Tab.Content>
                                    <Tab.Pane eventKey="react" className='border-0 pb-2'>
                                        <div className="p-4">
                                            ...
                                            <p className="mb-4 text-muted op-7 fw-normal text-center">Welcome back Jhon
                                                !</p>
                                            <div className="row gy-3">
                                                {err && <Alert variant="danger">{err}</Alert>}
                                                <Col xl={12}>
                                                    <Form.Label htmlFor="signin-username"
                                                ...
                                                <Col xl={12} className="mb-2">
                                                    <Form.Label htmlFor="signin-password"
                                                                className="form-label text-default d-block">Password
                                                        <Link to="#" className="float-end text-danger">Forget password
                                                            ?</Link></Form.Label>
                                                    <InputGroup>
                                                        <Form.Control size="lg"
                                                                      ...
                                                                      required
                                                        />
                                                        <Button variant='light' className="btn btn-light" type="button"
                                                    ...
                                                    <div className="mt-2">
                                                        <div className="form-check">
                                                            <Form.Check className="" type="checkbox" value=""
                                                                        id="defaultCheck1"/>
                                                            <Form.Label className=" text-muted fw-normal"
                                                ...
                                                <Col xl={12} className="d-grid mt-2">
                                                    <Button variant='primary' onClick={Login1} size='lg'
                                                            className="btn">Sign In</Button>
                                                </Col>
                                            </div>
                                            <div className="text-center">
                                                <p className="fs-12 text-muted mt-3">Dont have an account? <Link
                                                    to={`${import.meta.env.BASE_URL}authentication/signup/signupbasic`}
                                                    className="text-primary">Sign Up</Link></p>
                                            </div>
