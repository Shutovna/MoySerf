...
import ru.shutovna.myserf.validation.EmailValidator;
import ru.shutovna.myserf.validation.PasswordMatchesValidator;

import java.util.Locale;

@Configuration
@ComponentScan(basePackages = { "ru.shutovna.myserf.web" })
@EnableWebMvc
