...
import ru.shutovna.moyserf.validation.EmailValidator;
import ru.shutovna.moyserf.validation.PasswordMatchesValidator;

import java.util.Locale;

@Configuration
@ComponentScan(basePackages = {"ru.shutovna.moyserf.web"})
@EnableWebMvc
